...
static const char *printleftscreen[] = {
	"screenshotcustom.sh", "0", NULL
};

static const char *printrightscreen[] = {
	"screenshotcustom.sh", "1", NULL
};
...
static Key keys[] = {
	...
	{ Mod1Mask,						0xffc8,		spawn,			{.v = printleftscreen} },
	{ Mod1Mask,						0xffc9,		spawn,			{.v = printrightscreen} },
	TAGKEYS(                        0x26,                      0)
	TAGKEYS(                        0xe9,                      1)
	TAGKEYS(                        0x22,                      2)
	TAGKEYS(                        0x27,                      3)
